(
  function() {
    ...
    angular.module('AspernDashboardApp').service('ChartService', ChartService);

    ChartService.$inject=['DataService'];
    function ChartService(DataService){
      var chart = this;
      ...
      // var title = chart.subnode == null ? chart.subnet + ' - ' + chart.energyType : chart.subnet + ' - ' + chart.subnet + ' - ' + chart.energyType;
      ...
      var result = [];
        ...
        chart.getTitle = function(){
          var title = chart.subnode == null ? chart.subnet + ' - ' + chart.energyType : chart.subnet + ' - ' + chart.subnode + ' - ' + chart.energyType;
          return title;
        }

        chart.getUnit = function(){
          return unit;
        }
        ...
        chart.getChartData = function(energyType, subnet, subnode){
          chart.energyType = energyType;
          chart.subnode = subnode;
          chart.subnet = subnet;
          return data;
        }
