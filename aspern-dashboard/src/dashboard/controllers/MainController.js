(
  function() {
    ...
    MainController.$inject = ['LoginService', 'DataService', 'SESSION_DURATION', '$scope', '$http', '$cookies'];
    function MainController(LoginService, DataService, SESSION_DURATION, $scope, $http, $cookies){
      var main = this;
